...
def EVAL_GluCEST(data_path, seq_path):
    ...
    pixels_dict = { 
        'glu10mm+gln': [76,81,79,84],    # 250410
        'glu6mm+gln': [57,62,86,91],     # 250410
        'glu2mm+gln': [42,47,74,79],     # 250410
        'glu10mm+gaba': [46,51,54,59],   # 250410
        'glu6mm+gaba': [63,68,47,52],    # 250410
        'glu2mm+gaba': [78,83,60,65],    # 250410
    }
    ...
    pixels_glu2 = pixels_dict.get('glu2mm+gaba')
    ...
    # Save to text file
    np.savetxt(r'C:\asb\ntnu\master\GluCEST\flattened_glu1_opt.txt', flatten_glu1, fmt="%.6f")  # or fmt="%d" for integers
    np.savetxt(r'C:\asb\ntnu\master\GluCEST\flattened_glu2_opt.txt', flatten_glu2, fmt="%.6f")  # or fmt="%d" for integers'''
    ...
    plot_name = main_path + str("_Z_spectra_opt")
    ...
    plot_name = main_path + str("_MTR_spectra_opt")
    my_path = r"c:\asb\ntnu\plotting\master_thesis_pdf\mixed"
    save_path = os.path.join(my_path, plot_name + ".pdf")
    plt.savefig(save_path, format='pdf', bbox_inches='tight')
    #plt.show()
...
if __name__ == "__main__":
    ...
    EVAL_GluCEST(
        data_path=r'C:\asb\ntnu\MRIscans\250410\dicoms\mixed_E4', 
        seq_path=r'C:\asb\ntnu\MRIscans\250410\seq_files\seq_file_mixed_E4.seq',
    )