...
def EVAL_GluCEST(data_path, seq_path, date):
    ...
    pixels_0mm = [389,393,201,205] 
    pixels_2mm = [390,394,218,222] 
    pixels_4mm = [374,378,226,230] 
    pixels_6mm = [359,363,216,220] 
    pixels_8mm = [360,364,200,204] 
    pixels_10mm = [375,379,191,195] 
